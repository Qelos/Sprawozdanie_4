...

{
	...
	error = load_targa("blonde_girl_white_skin_3_20141210_1990831173.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku blonde_girl_white_skin_3_20141210_1990831173.tga");
